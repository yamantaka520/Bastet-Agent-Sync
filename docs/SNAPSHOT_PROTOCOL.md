...
- Limits: 1 MiB content/file, 256 files, 8 MiB aggregate content/bundle, 16 MiB serialized input, 4,096 objects and 64 MiB serialized valid objects per replica/transfer union. Counts and bytes are bounded during directory reads. This development ceiling must be revisited for large histories.
