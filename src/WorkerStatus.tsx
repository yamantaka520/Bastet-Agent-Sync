...
export const workerMessages = {
  ...
  en: [
    ...
    "Uploaded bundles",
    "Received bundles",
    "Applied conversations / memories",
    "Last completed",
...
export function phaseText(s: SyncStatus, locale: Locale) {
  ...
  return (
    (
      {
        credentials: {
          "zh-Hant": "🔐 正在讀取系統憑證；如有系統提示，請允許存取",
          "zh-Hans": "🔐 正在读取系统凭证；如有系统提示，请允许访问",
          en: "🔐 Reading system credentials; allow access if the OS prompts",
          ja: "🔐 システム認証情報を読み取り中。OS の確認があれば許可してください",
          ko: "🔐 시스템 자격 증명 읽는 중. OS 요청이 나타나면 허용하세요",
        }[locale],
        starting: t[2],
        syncing: t[3],
        waiting: t[4],
