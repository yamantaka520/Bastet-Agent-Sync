...
export const memoryMessages = {
  en: [
    ...
    "Unsupported or invalid export (maximum 8 MiB, versions 1–3).",
    "Version",
    "Records",
  ],
  "zh-Hant": [
  ...
  ja: [
    ...
    "未対応または無効なエクスポート（最大 8 MiB、バージョン 1–3）。",
    "バージョン",
    "レコード数",
  ],
  ko: [
    ...
    "지원되지 않거나 잘못된 내보내기 (최대 8 MiB, 버전 1–3).",
    "버전",
    "레코드 수",
  ],
} as const;
